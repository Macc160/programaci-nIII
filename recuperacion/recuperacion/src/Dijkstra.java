...
/**
 * Clase Dijkstra implementa el algoritmo para encontrar rutas más cortas en un grafo.
 */
public class Dijkstra {

    /**
     * Calcula las distancias más cortas desde un nodo inicial a todos los demás.
     * @param graph Grafo con las ciudades y conexiones.
     * @param start Ciudad inicial.
     * @return Mapa con las distancias mínimas desde la ciudad inicial.
     */
     ...
     * @return Lista con las ciudades en el camino más corto.
     */
