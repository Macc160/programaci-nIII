 ...
 * - Muestra el camino más corto y el más largo.
 */
public class Main {
    public static void main(String[] args) {
        ...
        graph.addEdge("Barranquilla", "Cartagena", 200); // Peso asumido para conexión directa
...
Camino más corto a Cartagena: " + shortestPath);
        ...
        // Camino más largo (máxima distancia en el mapa)
